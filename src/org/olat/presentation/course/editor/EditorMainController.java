        ...
        try {
            ...
            if (source == toolC) {
                ...
                if (event == NodeEditController.NODECONFIG_CHANGED_EVENT) {
                    ...
                    // ISSUE 7091 workaround - no publish changes when only HTML editor button is executed
                    if (!COMMAND_EDIT.equals(ureq.getParameter(VelocityContainer.COMMAND_ID))) {
