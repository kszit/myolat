...
public class IQManager extends BasicManager implements UserDataDeletable {
    ...
    public ItemsInput getItemsInput(final UserRequest ureq) {
        ...
        if (OLAT6824Logger.isDebugEnabled())
            OLAT6824Logger.debug("OLAT-6824 ItemsInput: Has Elements at all=" + params.hasMoreElements());
        while (params.hasMoreElements()) {
            ...
            if (OLAT6824Logger.isDebugEnabled())
                OLAT6824Logger.debug("OLAT-6824 ItemsInput-Parameter: Key=" + paramKey + "; Value=" + value + "; Tokens=" + st.countTokens());
            if (st.countTokens() == 4) {
                ...
                if (OLAT6824Logger.isDebugEnabled())
                    OLAT6824Logger.debug("OLAT-6824 ItemsInput-Item: Type=" + itemType + "; Ident=" + itemIdent + "; Response=" + responseID);
                ...
                if (itemType.equals("qti")) {
                    OLAT6824Logger.debug("OLAT-6824 ItemsInput-QTIcheck: Adding Single");
                    itemInput.putSingle(responseID, value);
                    OLAT6824Logger.debug("OLAT-6824 ItemsInput-QTIcheck: Single Added");
                }
            }
        ...
        if (OLAT6824Logger.isDebugEnabled())
            OLAT6824Logger.debug("OLAT-6824 ItemsInput-Final: Size=" + result.getItemCount());
        return result;
    }
